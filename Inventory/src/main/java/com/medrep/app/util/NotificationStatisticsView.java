...
public class NotificationStatisticsView extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(0).setCellValue("Doctor's Name");
		excelHeader.createCell(1).setCellValue("No. of Views per Doctor of Notification");
