  ...
  <div class="form-group row">
                    <div class="col-sm-6">
                     <!--    <label class="col-sm-4 control-label" for="userName-v">Medical Device Price<font color="red">*</font></label> -->
                        <div class="col-sm-8">
                             <input type="hidden" value=0 class="form-control required" name="device_price" id="device_price" >
                        </div>
                    </div>
                     <div class="col-sm-6">
                        <!-- <label class="col-sm-4 control-label" for="userName-v">Per<font color="red">*</font></label> -->
                        <div class="col-sm-8">
                          <input type="hidden" value=0 class="form-control required" placeholder="Unit" id="device_unit" name="device_unit"></textarea>
                          </div>
                        </div>
								...
								<div class="l-box-body">
								 <form action="../admin/devices.do" method="post" id="devicesRemoveUpdate">
									...
									<table id="dataTableId3" cellspacing="0" width="100%"
										...
										<tbody>
										<c:forEach var="orderdata" items="${orderformlist}">
											<tr>
												<td>
													<div class="checkbox">
															<label><input type="checkbox" name="removeReps" value="${orderdata.orderid}"></label>
													</div>
												</td>
												<td>${orderdata.companyName}</td>
												<td>${orderdata.deviceName}</td>
												<td>${orderdata.orderOn}</td>
												<td>${orderdata.doctorName}</td>
												<td>${orderdata.therapeuticName}</td>
													 		                    <%-- <td><a data-toggle="modal" data-target="#LargeModelNew" class="btn-link" onClick="viewModel(${orderid.orderid},'New')">View</a></td>  --%>
										</tr>
									</c:forEach>
								</tbody>
							</table>
