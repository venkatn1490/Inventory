...
<aside id="sb-left" class="l-sidebar l-sidebar-1 t-sidebar-1">
	...
	<div class="l-side-box">
		...
		<ul data-ason-type="menu" class="ason-widget">
			...
			<li><a href="../admin/doctors.do"><i class="icon fa fa-user-md"></i><span
			...
			<li><a href="../admin/news.do"><i
					class="icon fa fa-file-text"></i><span class="title">News
						</span></a></li>	
			<li><a href="../admin/transform.do"><i
					class="icon fa fa-graduation-cap"></i><span class="title">Transform
						</span></a></li>
			<li><a href="../admin/devices.do"><i
					class="icon fa fa-medkit"></i><span class="title">Medical Devices
						</span></a></li>		
			<li><a href="../admin/pharmaCampagin.do"><i
					class="icon fa fa-share-square-o"></i><span class="title">Pharma Campgain</span></a></li>
			<li><a href="../admin/pharmawebinars.do"><i
					class="icon fa fa-share-square-o"></i><span class="title">Pharma Webinars</span></a></li>	
		</ul>
		</nav>
	</div>
</aside>