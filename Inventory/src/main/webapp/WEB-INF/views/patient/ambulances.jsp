	...
	<ul class="breadcrumb t-breadcrumb-page">
		...
		<ul class="sub-menu-button">
			...
			<a href="../patient/hospital.do"	style="color: #d17b0b; font-size: 16px; letter-spacing: 1px;">
					Hospitals </a></li>
			<li class="orange-border" style="background-color:#d17b0b;"><a href="#"
				style="color: #fff; font-size: 16px; letter-spacing: 1px;">
				Ambulances	 </a></li>
			<li class="right-orange-border"><a href="../patient/diagnostic.do"
		...
		<div class="l-spaced">
			<div id="tables" class="resp-tabs-skin-1">
				<ul class="resp-tabs-list">
					<li id="nlist">Ambulances List</li>
					<li id="vscrollTable">Create Ambulance</li>
				</ul>
				<div class="resp-tabs-container">
								...
								<div class="l-box-body">
									<form action="../admin/devices.do" method="post"
									 ...
									 <table id="dataTableId" cellspacing="0" width="100%" class="display">
										...
										<tbody>
										<c:forEach var="devicesObj" items="${ambulanceslist}">
												<tr>
													<td>
														<div class="checkbox">
															<label><input type="radio" name="srado"
																value="${devicesObj.ambulance_id}"></label>
														</div>
													</td>
													
													<td>${devicesObj.ambulance_name}</td>
													<td>AM${devicesObj.ambulance_id}</td>	
													...
													<td><a data-toggle="modal" data-target="#LargeModel" class="btn-link" onClick="viewDeviceModel(${devicesObj.ambulance_id})">View</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
														...
														<div class="modal-body">
															<dl class="dl-horizontal-patient">
																...
																<div class="col-md-12 col-sm-12">
																	...
																	<div class="col-md-7 col-sm-7">
																		<dd id="therapeuticArea">Rs.1125</dd>
																	</div>
																</div>
					...
					<div class="l-row l-spaced-bottom">
						<div class="l-box">
							<div class="l-box-header">
								<h2 class="l-box-title">
									<span>Create</span> Ambulance
								</h2>
							</div>
							<section class="l-box-body l-spaced">
								<form id="createAmbulances" class="form-horizontal validate"
									role="form" action="../patient/createAmbulances.do"
									method="post" enctype="multipart/form-data">

									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Ambulance
												Name<font color="red">*</font>
											</label>
											<div class="col-sm-8">
												<input type="text" class="form-control required"
													name="AmbulancesName" id="AmbulancesName">
											</div>
										</div>
										<div class="col-sm-6">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">CollectionFee<font color="red"></font>
											</label>
											<div class="col-sm-8">
												<input type="text" class="form-control required"
													name="collectionFee" id="collectionFee">
											</div>
										</div>
										<div class="col-sm-6">
									...
									<div class="form-group row">
									<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Ambulance Thumb Image</label>
											<div class="col-sm-8">
												<div class="input-group">
													<span class="input-group-btn"><span
														class="btn btn-primary btn-file">Upload File... <input
															type="file" required="required" id="AmbulancesLogo"
															name="AmbulancesLogo" size="50"></span></span> <input type="text"
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Ambulance  Image</label>
											<div class="col-sm-8">
												<div class="input-group">
													<span class="input-group-btn"><span
														class="btn btn-primary btn-file">Upload File... <input
															type="file" required="required" id="AmbulancesImage"
															name="AmbulancesImage" size="50"></span></span> <input type="text"
														class="form-control" readonly name="LogoName">
												</div>
											</div>
										</div>
											...
											<div class="col-sm-6">
												...
												<div class="col-sm-8">
													...
													<button type="submit" class="btn btn-green"
														...
														form="createAmbulances">Create</button>
												</div>
											</div>
										</div>
										<div class="form-group row">
