...
<div class="l-page-header">
	...
	<ul class="breadcrumb t-breadcrumb-page">
		...
		<ul class="sub-menu-button">
			<li class="left-orange-border"><a href="#"
		...
		<div class="l-spaced">
			<div id="tables" class="resp-tabs-skin-1">
				<ul class="resp-tabs-list">
					<li id="nlist">Hospitals List</li>
					<li id="vscrollTable">Create Hospital</li>
				</ul>
									 ...
									 <table id="dataTableId" cellspacing="0" width="100%" class="display">
										...
										<c:forEach var="devicesObj" items="${hospitallist}">
												<tr>
													<td>
														<div class="checkbox">
															<label><input type="radio" name="srado"
																value="${devicesObj.hospital_id}"></label>
														</div>
													</td>
													
													<td>${devicesObj.hospital_name}</td>
													<td>HS${devicesObj.hospital_id}</td>	
													...
													<td><a data-toggle="modal" data-target="#LargeModel" class="btn-link" onClick="viewDeviceModel(${devicesObj.hospital_id})">View</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
															...
															<dl class="dl-horizontal-patient">
																...
																<div class="col-md-12 col-sm-12">
																	...
																	<div class="col-md-8 col-sm-8">
																		<dd id="DeviceName">Sri Krishna Hospitals</dd>
																	</div>
																</div>
					...
					<div class="l-row l-spaced-bottom">
						<div class="l-box">
							...
							<section class="l-box-body l-spaced">
								<form id="createHospital" class="form-horizontal validate"
									role="form" action="../patient/createHospital.do"
									method="post" enctype="multipart/form-data">

									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Hospital
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<label for="City-v" class="col-sm-4 control-label">City<font
												color="red">*</font></label>
											<div class="col-sm-8">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Hospital Thumb Image</label>
											<div class="col-sm-8">
												<div class="input-group">
													<span class="input-group-btn"><span
														class="btn btn-primary btn-file">Upload File... <input
															type="file" required="required" id="HospitalLogoImage"
															name="HospitalLogoImage" size="50"></span></span> <input type="text"
										...
										<div class="col-sm-6">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control required"
													name="hospitalAddress1" id="hospitalAddress1">
											</div>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-6">
											<label class="col-sm-4 control-label" for="userName-v">Hospital Images</label>
											<div class="col-sm-8">
												<div class="input-group">
													<span class="input-group-btn"><span
														class="btn btn-primary btn-file">Upload File... <input
															type="file" required="required" id="HospitalImage"
															name="HospitalImage" size="50"></span></span> <input type="text"
														class="form-control" readonly name="HospitalImage">
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control required"
													name="hospitalAddress2" id="hospitalAddress2">
											</div>
										</div>
									</div>
									<div class="form-group row">
											...
											<div class="col-sm-6">
												...
												<div class="col-sm-8">
													...
													<button type="submit" class="btn btn-green"
														...
														form="createHospital">Create</button>
												</div>
											</div>
										</div>
										<div class="form-group row">
