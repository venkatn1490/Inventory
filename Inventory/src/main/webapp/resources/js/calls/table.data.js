...
$(function(){
    ...
    var dataTableId_1 = "#dataTableId",
        ...
        dataTableId_6 = "#dataTableId1", 
        dataTableId_7 = "#dataTableId2",
        dataTableId_8 = "#dataTableId3", 
        tabs          = "#tables";
    ...
    runDataTable(dataTableId_6,'default');
    runDataTable(dataTableId_7,'default');
    runDataTable(dataTableId_8,'default');
