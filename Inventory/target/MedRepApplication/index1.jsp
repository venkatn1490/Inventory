...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" href='<c:url value="/resources/css/flickity.css"/>'>
		<link rel="stylesheet" href='<c:url value="/resources/css/animate.css"/>'>
		<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
		<link rel="stylesheet" href='http://fonts.googleapis.com/css?family=Nunito:400,300,700' rel='stylesheet' type='text/css'>
		<link rel="stylesheet" href='<c:url value="/resources/css/styles.css"/>'>
		<link rel="stylesheet" href='<c:url value="/resources/css/queries.css"/>'>
				...
				<div class="container">
					<div class="row nav-wrapper">
						<div class="col-md-6 col-sm-6 col-xs-6 text-left">
							<a href="index.html"><img src='<c:url value="/resources/img/logo-new.png"/>' alt="Boxify Logo"></a>
						</div>
					...
					<div class="row hero-content">
						<div class="col-md-12">
							<h1 class="animated fadeInDown"><span>Integrating The Complete</span> <br>Healthcare <br>Ecosysytem</h1>
						</div>
