	...
	public static String getLocationType(String locationType) {
		...
		try {
			if (locationType != null) {
				...
				case 1:
					location = "PARTNERED HOSPITAL";
					break;
				case 2:
					location = "OTHER HOSPITAL / CLINIC";
					break;
				default:
					location="Hospital";
				}
			...
			if("PARTNERED HOSPITAL".equalsIgnoreCase(locationType))
				location="PARTNERED HOSPITAL";
			else if("OTHER HOSPITAL/CLINIC".equalsIgnoreCase(locationType))
				location="OTHER HOSPITAL/CLINIC";
		}
		return location;
	}
