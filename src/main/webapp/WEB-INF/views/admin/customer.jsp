		...
		<div class="l-spaced">
			<div id="tables" class="resp-tabs-skin-1">
				<ul class="resp-tabs-list">
					<li id="nlist">Customers List</li>
					<li id="vscrollTable">Create Customer</li>
...
<div class="l-row l-spaced-bottom">
                <div class="l-box">
                <div class="l-box-header">
                  <h2 class="l-box-title"><span>Create</span> Customer</h2></div>
                  <section class="l-box-body l-spaced">
                  <form id="createCustomner" class="form-horizontal validate" role="form" action="../admin/createUser.do" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-8">
                   <button type="submit" class="btn btn-green" name="buttonName" value="Create"  onclick= "return fnSubmit(this);" form="createCustomner">Create</button>
                  </div>
                </div>
               </div>
              </form>
