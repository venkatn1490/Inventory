		...
		<div class="l-spaced">
			<div id="tables" class="resp-tabs-skin-1">
				<ul class="resp-tabs-list">
					<li id="nlist">Salesman List</li>
					<li id="vscrollTable">Create Salesman</li>
...
<div class="l-row l-spaced-bottom">
                <div class="l-box">
                <div class="l-box-header">
                  <h2 class="l-box-title"><span>Create</span> Salesman</h2></div>
                  <section class="l-box-body l-spaced">
                  <form id="createSalesman" class="form-horizontal validate" role="form" action="../admin/createSalesman.do" method="post" enctype="multipart/form-data">
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                     <div class="col-sm-6">
						...
						<input type="number" class="form-control required" style="display: none" name="role" id="role" value="4"></div>
					</div>
					<div class="col-sm-6">
					 <label class="col-sm-4 control-label" for="userName-v">Select Purchaser<font color="red">*</font></label>
					<select name="purchaser" required="required" >
					<c:forEach var="purchaserList" items="${purchaserList}">
                        	<option value="${purchaserList.userId}">${purchaserList.firstName}</option>
						</c:forEach>
						</select>																
						</div>
                        </div>
                ...
                <div class="form-group row">
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-8">
                   <button type="submit" class="btn btn-green" name="buttonName" value="Create"  onclick= "return fnSubmit(this);" form="createSalesman">Create</button>
                  </div>
                </div>
               </div>
              </form>
