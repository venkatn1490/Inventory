		...
		<div class="l-spaced">
			<div id="tables" class="resp-tabs-skin-1">
				<ul class="resp-tabs-list">
					<li id="nlist">Suppliers List</li>
					<li id="vscrollTable">Create Supplier</li>
...
<div class="l-row l-spaced-bottom">
                ...
                <div class="l-box-header">
                  ...
                  <form id="createSupplier" class="form-horizontal validate" role="form" action="../admin/createUser.do" method="post" enctype="multipart/form-data">
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                     <div class="col-sm-6">
						...
						<input type="number" class="form-control required" style="display: none" name="role" id="role" value="2"></div>
													</div>
                        </div>
                ...
                <div class="form-group row">
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-8">
                   <button type="submit" class="btn btn-green" name="buttonName" value="Create"  onclick= "return fnSubmit(this);" form="createSupplier">Create</button>
                  </div>
                </div>
               </div>
              </form>
