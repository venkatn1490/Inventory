...
<div class="l-box no-border">
	<div class="l-box l-spaced-bottom">
		...
		<div class="resp-tabs-container">
									...
									<table id="dataTableId" cellspacing="0" width="100%"
										...
										<c:forEach var="orderList" items="${orderList}">
												<tr>
													...
													<td>${orderList.purchaserName}</td>
													<td>${orderList.purchaserMobile}</td>	
					...
					<form action="../purchaser/orderItems.do" id="myOrderItems" method="get" target="_blank" enctype="multipart/form-data" >
                ...
                <div class="l-box-header">
                  ...
                  <form id="createOrder" class="form-horizontal validate" role="form" action="../purchaser/createOrder.do" method="post" enctype="multipart/form-data">
					...
					<div class="col-sm-6">
					 <label class="col-sm-4 control-label" for="userName-v">Select Supplier<font color="red">*</font></label>
					<select name="supplierId" required="required" >
					<c:forEach var="supplierList" items="${supplierList}">
                        	<option value="${supplierList.userId}">${supplierList.firstName}</option>
						</c:forEach>
						</select>																
						</div>
                        </div>
                ...
                <div class="form-group row">
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-8">
                   <button type="submit" class="btn btn-green" name="buttonName" value="Create"  onclick= "return fnSubmit(this);" form="createOrder">Create</button>
                  </div>
                </div>
               </div>
              </form>
