...
<div class="l-row l-spaced-bottom">
                ...
                <div class="l-box-header">
                  ...
                  <form id="createUser" class="form-horizontal validate" role="form" action="../salesman/createUser.do" method="post" enctype="multipart/form-data">
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                     <div class="col-sm-6">
						...
						<input type="number" class="form-control required" style="display: none" name="role" id="role" value="5"></div>
					</div>
                ...
                <div class="form-group row">
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-8">
                   <button type="submit" class="btn btn-green" name="buttonName" value="Create"  onclick= "return fnSubmit(this);" form="createUser">Create</button>
                  </div>
                </div>
               </div>
              </form>
