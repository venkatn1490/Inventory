			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
						<div class="col-md-12">
							<h1 class="animated fadeInDown"><span>Integrating The</span><br>Inventory System</h1>
						</div>
						<div class="col-md-12 btn-bottom">
							<a href="./web/auth/register.do" class="use-btn animated fadeInUp">Register</a>
							<a href="./web/auth/login.do" class="use-btn animated fadeInUp">Login</a>
